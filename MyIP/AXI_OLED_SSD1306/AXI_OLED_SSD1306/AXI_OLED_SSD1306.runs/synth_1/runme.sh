...
HD_PWD='D:/01_Xilinx_FPGA/00_BasicMicroblaze/MyIP/AXI_OLED_SSD1306/AXI_OLED_SSD1306/AXI_OLED_SSD1306.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSD1306_OLED_ML.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SSD1306_OLED_ML.tcl
