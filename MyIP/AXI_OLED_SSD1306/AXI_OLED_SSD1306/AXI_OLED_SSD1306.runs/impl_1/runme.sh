...
HD_PWD='D:/01_Xilinx_FPGA/00_BasicMicroblaze/MyIP/AXI_OLED_SSD1306/AXI_OLED_SSD1306/AXI_OLED_SSD1306.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SSD1306_OLED_ML.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SSD1306_OLED_ML.tcl -notrace
